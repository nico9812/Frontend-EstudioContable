import '@/pages/users/clientes.scss';
    ...
    <div className="body">
          ...
          >
            <Col sm="15">
              <Form.Control
                size="lg"
                type="password"
                placeholder="Coonfirma la Contraseña"
                {...register('passwordConfirm', { required: true })}
              />
            </Col>
            {errorForm.passwordConfirm && (
              <span>{errorForm.passwordConfirm[0]}</span>
            )}
          </Form.Group>
      ...
      >
        <p>
          ...
          {usuarioSelected != null && usuarioSelected.username} como cliente,
          esto borrara todos sus registros?
        </p>
        <Col sm="15" className="d-flex justify-content-between">
          <Button
            variant="success"
            onClick={() =>
              handleDeleteUser(usuarioSelected != null && usuarioSelected.id)
            }
          >
            Aceptar
          </Button>
